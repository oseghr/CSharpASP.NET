...
namespace ClassLibrary1
{
    ...
    /// </summary>    
    public class PostEmailViewCreates : Plugint
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostEmailViewCreates"/> class.
        /// </summary>
        /// <param name="unsecure">Contains public (unsecured) configuration information.</param>
        /// <param name="secure">Contains non-public (secured) configuration information. 
        /// When using Microsoft Dynamics 365 for Outlook with Offline Access, 
        /// the secure string is not passed to a plug-in that executes while the client is offline.</param>
        public PostEmailViewCreates(string unsecure, string secure)
            : base(typeof(PostEmailViewCreates))
        {
        ...
        protected void ExecutePostEmailViewCreate(LocalPluginContext localContext)
        {
            ...
            {                             
                ...
                using (var svcContext = new NISvcContext(localContext.OrganizationService))
                {
                    ...
                    localContext.TracingService.Trace("== Calling Email VIEW START ==");
                    ...
                    localContext.TracingService.Trace("== Calling Email VIEW END ==");
                    ...
                    localContext.TracingService.Trace("== Calling Email QUEUE START ==");
                    svcContext.AddObject(email);
                    svcContext.UpdateObject(emailview_entity);
                    svcContext.SaveChanges();
                    localContext.TracingService.Trace("== Calling ALL Email View End ==");
                }
            }
        }
    }
